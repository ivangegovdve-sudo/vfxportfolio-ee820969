...
Source category: `Plugins`

Files included: 5

---

## File: `plugins/agent-tools.md`

Source URL: https://docs.openclaw.ai/plugins/agent-tools.md
...
## File: `plugins/community.md`

Source URL: https://docs.openclaw.ai/plugins/community.md
...
* **WeChat** â€” Connect OpenClaw to WeChat personal accounts via WeChatPadPro (iPad protocol). Supports text, image, and file exchange with keyword-triggered conversations.
...
Source URL: https://docs.openclaw.ai/plugins/manifest.md
...
## File: `plugins/voice-call.md`

Source URL: https://docs.openclaw.ai/plugins/voice-call.md
...
## File: `plugins/zalouser.md`

Source URL: https://docs.openclaw.ai/plugins/zalouser.md
