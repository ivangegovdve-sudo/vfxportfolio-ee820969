...
Source category: `Channels`

Files included: 29

---

## File: `channels/bluebubbles.md`

Source URL: https://docs.openclaw.ai/channels/bluebubbles.md
...
Source URL: https://docs.openclaw.ai/channels/broadcast-groups.md
...
## File: `channels/channel-routing.md`

Source URL: https://docs.openclaw.ai/channels/channel-routing.md
...
To prevent the sessionâ€™s `lastRoute` from being overwritten by non-owner DMs,
...
Source URL: https://docs.openclaw.ai/channels/discord.md
...
## File: `channels/feishu.md`

Source URL: https://docs.openclaw.ai/channels/feishu.md
...
2. Go to **Development** â†’ **Events & Callbacks** (å¼€å‘é…ç½® â†’ äº‹ä»¶ä¸Žå›žè°ƒ)
3. Open the **Encryption** tab (åŠ å¯†ç­–ç•¥)
...
## File: `channels/googlechat.md`

Source URL: https://docs.openclaw.ai/channels/googlechat.md
...
## File: `channels/group-messages.md`

Source URL: https://docs.openclaw.ai/channels/group-messages.md
...
## File: `channels/groups.md`

Source URL: https://docs.openclaw.ai/channels/groups.md
...
## File: `channels/imessage.md`

Source URL: https://docs.openclaw.ai/channels/imessage.md
...
Source URL: https://docs.openclaw.ai/channels/index.md
...
* [Feishu](/channels/feishu) â€” Feishu/Lark bot via WebSocket (plugin, installed separately).
* [Google Chat](/channels/googlechat) â€” Google Chat API app via HTTP webhook.
* [iMessage (legacy)](/channels/imessage) â€” Legacy macOS integration via imsg CLI (deprecated, use BlueBubbles for new setups).
* [IRC](/channels/irc) â€” Classic IRC servers; channels + DMs with pairing/allowlist controls.
...
* [Synology Chat](/channels/synology-chat) â€” Synology NAS Chat via outgoing+incoming webhooks (plugin, installed separately).
...
## File: `channels/irc.md`

Source URL: https://docs.openclaw.ai/channels/irc.md
...
Source URL: https://docs.openclaw.ai/channels/line.md
...
## File: `channels/location.md`

Source URL: https://docs.openclaw.ai/channels/location.md
...
Source URL: https://docs.openclaw.ai/channels/matrix.md
...
Source URL: https://docs.openclaw.ai/channels/mattermost.md
...
1. All buttons are replaced with a confirmation line (e.g., "âœ“ **Yes** selected by @user").
...
* Mattermost strips callback data from its API responses (security feature), so all buttons
  are removed on click â€” partial removal is not possible.
...
2. Every action needs `type: "button"` â€” without it, clicks are swallowed silently.
3. Every action needs an `id` field â€” Mattermost ignores actions without IDs.
...
6. `context.action_id` is required â€” the interaction handler returns 400 without it.
...
* Use `sort_keys=True` â€” the gateway sorts keys before signing, and Mattermost may
...
No configuration is needed â€” the adapter uses the bot token from the account config.
...
## File: `channels/msteams.md`

Source URL: https://docs.openclaw.ai/channels/msteams.md
...
Source URL: https://docs.openclaw.ai/channels/nextcloud-talk.md
...
## File: `channels/nostr.md`

Source URL: https://docs.openclaw.ai/channels/nostr.md
...
## File: `channels/pairing.md`

Source URL: https://docs.openclaw.ai/channels/pairing.md
...
â€œPairingâ€ is OpenClawâ€™s explicit **owner approval** step.
...
Source URL: https://docs.openclaw.ai/channels/signal.md
...
Source URL: https://docs.openclaw.ai/channels/slack.md
...
## File: `channels/synology-chat.md`

Source URL: https://docs.openclaw.ai/channels/synology-chat.md
...
## File: `channels/telegram.md`

Source URL: https://docs.openclaw.ai/channels/telegram.md
...
## File: `channels/tlon.md`

Source URL: https://docs.openclaw.ai/channels/tlon.md
...
âš ï¸ Only enable this if you trust your local network. This setting disables SSRF protections
...
The owner ship is **automatically authorized everywhere** â€” DM invites are auto-accepted and
...
| --------------- | -------------------------------------- |
| Direct messages | âœ… Supported                            |
| Groups/channels | âœ… Supported (mention-gated by default) |
| Threads         | âœ… Supported (auto-replies in thread)   |
| Rich text       | âœ… Markdown converted to Tlon format    |
| Images          | âœ… Uploaded to Tlon storage             |
| Reactions       | âœ… Via [bundled skill](#bundled-skill)  |
| Polls           | âŒ Not yet supported                    |
| Native commands | âœ… Supported (owner-only by default)    |
...
## File: `channels/troubleshooting.md`

Source URL: https://docs.openclaw.ai/channels/troubleshooting.md
...
## File: `channels/twitch.md`

Source URL: https://docs.openclaw.ai/channels/twitch.md
...
Source URL: https://docs.openclaw.ai/channels/whatsapp.md
...
## File: `channels/zalo.md`

Source URL: https://docs.openclaw.ai/channels/zalo.md
...
| --------------- | -------------------------------------------------------- |
| Direct messages | âœ… Supported                                              |
| Groups          | âš ï¸ Supported with policy controls (allowlist by default) |
| Media (images)  | âœ… Supported                                              |
| Reactions       | âŒ Not supported                                          |
| Threads         | âŒ Not supported                                          |
| Polls           | âŒ Not supported                                          |
| Native commands | âŒ Not supported                                          |
...
## File: `channels/zalouser.md`

Source URL: https://docs.openclaw.ai/channels/zalouser.md
