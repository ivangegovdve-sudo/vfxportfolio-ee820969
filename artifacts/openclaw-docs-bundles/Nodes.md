...
Source URL: https://docs.openclaw.ai/nodes/audio.md
  ...
  tools: {
    media: {
      audio: {
        ...
        echoFormat: 'ðŸ“ "{transcript}"', // optional, supports {transcript}
        models: [{ provider: "openai", model: "gpt-4o-mini-transcribe" }],
      },
    },
  },
...
## File: `nodes/camera.md`

Source URL: https://docs.openclaw.ai/nodes/camera.md
...
## File: `nodes/images.md`

Source URL: https://docs.openclaw.ai/nodes/images.md
...
Source URL: https://docs.openclaw.ai/nodes/index.md
...
macOS can also run in **node mode**: the menubar app connects to the Gatewayâ€™s WS server and exposes its local canvas/camera commands as a node (so `openclaw nodes â€¦` works against this Mac).
...
* The macOS menubar app connects to the Gateway WS server as a node (so `openclaw nodes â€¦` works against this Mac).
...
## File: `nodes/location-command.md`

Source URL: https://docs.openclaw.ai/nodes/location-command.md
...
## File: `nodes/media-understanding.md`

Source URL: https://docs.openclaw.ai/nodes/media-understanding.md
...
Source URL: https://docs.openclaw.ai/nodes/talk.md
...
## File: `nodes/troubleshooting.md`

Source URL: https://docs.openclaw.ai/nodes/troubleshooting.md
...
* `NODE_BACKGROUND_UNAVAILABLE` â†’ app is backgrounded; bring it foreground.
* `CAMERA_DISABLED` â†’ camera toggle disabled in node settings.
* `*_PERMISSION_REQUIRED` â†’ OS permission missing/denied.
* `LOCATION_DISABLED` â†’ location mode is off.
* `LOCATION_PERMISSION_REQUIRED` â†’ requested location mode not granted.
* `LOCATION_BACKGROUND_UNAVAILABLE` â†’ app is backgrounded but only While Using permission exists.
* `SYSTEM_RUN_DENIED: approval required` â†’ exec request needs explicit approval.
* `SYSTEM_RUN_DENIED: allowlist miss` â†’ command blocked by allowlist mode.
...
## File: `nodes/voicewake.md`

Source URL: https://docs.openclaw.ai/nodes/voicewake.md
