...
## File: `tools/acp-agents.md`

Source URL: https://docs.openclaw.ai/tools/acp-agents.md
...
ACP sessions run non-interactively â€” there is no TTY to approve or deny file-write and shell-exec permission prompts. The acpx plugin provides two config keys that control how permissions are handled:
...
## File: `tools/agent-send.md`

Source URL: https://docs.openclaw.ai/tools/agent-send.md
...
## File: `tools/apply-patch.md`

Source URL: https://docs.openclaw.ai/tools/apply-patch.md
...
Source URL: https://docs.openclaw.ai/tools/browser.md
...
* **HTTP(S) endpoints** (e.g. Browserless) â€” OpenClaw calls `/json/version` to
  discover the WebSocket debugger URL, then connects.
* **WebSocket endpoints** (`ws://` / `wss://`) â€” OpenClaw connects directly,
...
## File: `tools/browser-linux-troubleshooting.md`

Source URL: https://docs.openclaw.ai/tools/browser-linux-troubleshooting.md
...
## File: `tools/browser-login.md`

Source URL: https://docs.openclaw.ai/tools/browser-login.md
...
## File: `tools/chrome-extension.md`

Source URL: https://docs.openclaw.ai/tools/chrome-extension.md
...
## File: `tools/clawhub.md`

Source URL: https://docs.openclaw.ai/tools/clawhub.md
...
## File: `tools/creating-skills.md`

Source URL: https://docs.openclaw.ai/tools/creating-skills.md
...
Source URL: https://docs.openclaw.ai/tools/diffs.md
...
## File: `tools/elevated.md`

Source URL: https://docs.openclaw.ai/tools/elevated.md
...
Source URL: https://docs.openclaw.ai/tools/exec.md
...
## File: `tools/exec-approvals.md`

Source URL: https://docs.openclaw.ai/tools/exec-approvals.md
...
## File: `tools/firecrawl.md`

Source URL: https://docs.openclaw.ai/tools/firecrawl.md
...
Source URL: https://docs.openclaw.ai/tools/index.md
...
## File: `tools/llm-task.md`

Source URL: https://docs.openclaw.ai/tools/llm-task.md
...
Source URL: https://docs.openclaw.ai/tools/lobster.md
...
> Typed workflow runtime for OpenClaw â€” composable pipelines with approval gates.
...
* **Hardened** â€” fixed executable name (`lobster`) on `PATH`; timeouts and output caps enforced.
...
## File: `tools/loop-detection.md`

Source URL: https://docs.openclaw.ai/tools/loop-detection.md
...
## File: `tools/multi-agent-sandbox-tools.md`

Source URL: https://docs.openclaw.ai/tools/multi-agent-sandbox-tools.md
...
Source URL: https://docs.openclaw.ai/tools/pdf.md
...
## File: `tools/plugin.md`

Source URL: https://docs.openclaw.ai/tools/plugin.md
...
This lets read-only commands report â€œconfigured but unavailable in this command
pathâ€ instead of crashing or misreporting the account as not configured.
...
## File: `tools/reactions.md`

Source URL: https://docs.openclaw.ai/tools/reactions.md
...
Source URL: https://docs.openclaw.ai/tools/skills.md
...
## File: `tools/skills-config.md`

Source URL: https://docs.openclaw.ai/tools/skills-config.md
...
## File: `tools/slash-commands.md`

Source URL: https://docs.openclaw.ai/tools/slash-commands.md
...
Source URL: https://docs.openclaw.ai/tools/subagents.md
...
1. Depth-2 worker finishes â†’ announces to its parent (depth-1 orchestrator)
2. Depth-1 orchestrator receives the announce, synthesizes results, finishes â†’ announces to main
...
* **Depth 2 (leaf worker)**: No session tools â€” `sessions_spawn` is always denied at depth 2. Cannot spawn further children.
...
* Maximum nesting depth is 5 (`maxSpawnDepth` range: 1â€“5). Depth 2 is recommended for most use cases.
* `maxChildrenPerAgent` caps active children per session (default: 5, range: 1â€“20).
...
## File: `tools/thinking.md`

Source URL: https://docs.openclaw.ai/tools/thinking.md
...
* Levels (aliases): `off | minimal | low | medium | high | xhigh | adaptive`
  ...
  * adaptive â†’ provider-managed adaptive reasoning budget (supported for Anthropic Claude 4.6 model family)
...
Source URL: https://docs.openclaw.ai/tools/web.md
...
* `web_search` â€” Search the web using Brave Search API, Gemini with Google Search grounding, Grok, Kimi, or Perplexity Search API.
...
| **Gemini**                | AI-synthesized answers + citations | â€”                                            | Uses Google Search grounding                                                   | `GEMINI_API_KEY`                            |
| **Grok**                  | AI-synthesized answers + citations | â€”                                            | Uses xAI web-grounded responses                                                | `XAI_API_KEY`                               |
| **Kimi**                  | AI-synthesized answers + citations | â€”                                            | Uses Moonshot web search                                                       | `KIMI_API_KEY` / `MOONSHOT_API_KEY`         |
...
1. **Brave** â€” `BRAVE_API_KEY` env var or `tools.web.search.apiKey` config
2. **Gemini** â€” `GEMINI_API_KEY` env var or `tools.web.search.gemini.apiKey` config
3. **Grok** â€” `XAI_API_KEY` env var or `tools.web.search.grok.apiKey` config
4. **Kimi** â€” `KIMI_API_KEY` / `MOONSHOT_API_KEY` env var or `tools.web.search.kimi.apiKey` config
5. **Perplexity** â€” `PERPLEXITY_API_KEY`, `OPENROUTER_API_KEY`, or `tools.web.search.perplexity.apiKey` config
