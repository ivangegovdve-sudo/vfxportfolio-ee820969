...
Source URL: https://docs.openclaw.ai/providers/anthropic.md
...
Source URL: https://docs.openclaw.ai/providers/bedrock.md
...
OpenClaw can use **Amazon Bedrock** models via piâ€‘aiâ€™s **Bedrock Converse**
streaming provider. Bedrock auth uses the **AWS SDK default credential chain**,
not an API key.

## What piâ€‘ai supports
...
## File: `providers/claude-max-api-proxy.md`

Source URL: https://docs.openclaw.ai/providers/claude-max-api-proxy.md
...
## File: `providers/cloudflare-ai-gateway.md`

Source URL: https://docs.openclaw.ai/providers/cloudflare-ai-gateway.md
...
## File: `providers/deepgram.md`

Source URL: https://docs.openclaw.ai/providers/deepgram.md
...
## File: `providers/github-copilot.md`

Source URL: https://docs.openclaw.ai/providers/github-copilot.md
...
## File: `providers/glm.md`

Source URL: https://docs.openclaw.ai/providers/glm.md
...
## File: `providers/huggingface.md`

Source URL: https://docs.openclaw.ai/providers/huggingface.md
...
1. Create a fine-grained token at [Hugging Face â†’ Settings â†’ Tokens](https://huggingface.co/settings/tokens/new?ownUserPermissions=inference.serverless.write\&tokenType=fineGrained) with the **Make calls to Inference Providers** permission.
...
* **Name from API:** The model display name is **hydrated from GET /v1/models** when the API returns `name`, `title`, or `display_name`; otherwise it is derived from the model id (e.g. `deepseek-ai/DeepSeek-R1` â†’ â€œDeepSeek R1â€).
...
* **Provider / policy selection:** Append a suffix to the **model id** to choose how the router picks the backend:
  ...
  * **`:fastest`** â€” highest throughput (router picks; provider choice is **locked** â€” no interactive backend picker).
  * **`:cheapest`** â€” lowest cost per output token (router picks; provider choice is **locked**).
  * **`:provider`** â€” force a specific backend (e.g. `:sambanova`, `:together`).

  When you select **:cheapest** or **:fastest** (e.g. in the onboarding model dropdown), the provider is locked: the router decides by cost or speed and no optional â€œprefer specific backendâ€ step is shown. You can add these as separate entries in `models.providers.huggingface.models` or set `model.primary` with the suffix. You can also set your default order in [Inference Provider settings](https://hf.co/settings/inference-providers) (no suffix = use that order).
...
Source URL: https://docs.openclaw.ai/providers/index.md
...
## File: `providers/kilocode.md`

Source URL: https://docs.openclaw.ai/providers/kilocode.md
...
## File: `providers/litellm.md`

Source URL: https://docs.openclaw.ai/providers/litellm.md
...
* **Cost tracking** â€” See exactly what OpenClaw spends across all models
* **Model routing** â€” Switch between Claude, GPT-4, Gemini, Bedrock without config changes
* **Virtual keys** â€” Create keys with spend limits for OpenClaw
* **Logging** â€” Full request/response logs for debugging
* **Fallbacks** â€” Automatic failover if your primary provider is down
...
OpenClaw keeps requesting `claude-opus-4-6` â€” LiteLLM handles the routing.
...
* All OpenClaw features work through LiteLLM â€” no limitations
...
## File: `providers/minimax.md`

Source URL: https://docs.openclaw.ai/providers/minimax.md
...
### â€œUnknown model: minimax/MiniMax-M2.5â€
...
Source URL: https://docs.openclaw.ai/providers/mistral.md
...
## File: `providers/models.md`

Source URL: https://docs.openclaw.ai/providers/models.md
...
## File: `providers/moonshot.md`

Source URL: https://docs.openclaw.ai/providers/moonshot.md
...
## File: `providers/nvidia.md`

Source URL: https://docs.openclaw.ai/providers/nvidia.md
...
Source URL: https://docs.openclaw.ai/providers/ollama.md
...
Source URL: https://docs.openclaw.ai/providers/openai.md
...
## File: `providers/opencode.md`

Source URL: https://docs.openclaw.ai/providers/opencode.md
...
## File: `providers/opencode-go.md`

Source URL: https://docs.openclaw.ai/providers/opencode-go.md
...
Source URL: https://docs.openclaw.ai/providers/openrouter.md
...
## File: `providers/qianfan.md`

Source URL: https://docs.openclaw.ai/providers/qianfan.md
...
## File: `providers/qwen.md`

Source URL: https://docs.openclaw.ai/providers/qwen.md
...
## File: `providers/synthetic.md`

Source URL: https://docs.openclaw.ai/providers/synthetic.md
...
## File: `providers/together.md`

Source URL: https://docs.openclaw.ai/providers/together.md
...
## File: `providers/venice.md`

Source URL: https://docs.openclaw.ai/providers/venice.md
...
### Private Models (26) â€” Fully Private, No Logging
...
### Anonymized Models (15) â€” Via Venice Proxy
...
## File: `providers/vercel-ai-gateway.md`

Source URL: https://docs.openclaw.ai/providers/vercel-ai-gateway.md
...
## File: `providers/vllm.md`

Source URL: https://docs.openclaw.ai/providers/vllm.md
...
## File: `providers/xiaomi.md`

Source URL: https://docs.openclaw.ai/providers/xiaomi.md
...
## File: `providers/zai.md`

Source URL: https://docs.openclaw.ai/providers/zai.md
