...
Source URL: https://docs.openclaw.ai/cli/acp.md
...
Source URL: https://docs.openclaw.ai/cli/agent.md
...
Source URL: https://docs.openclaw.ai/cli/agents.md
...
## File: `cli/approvals.md`

Source URL: https://docs.openclaw.ai/cli/approvals.md
...
Source URL: https://docs.openclaw.ai/cli/browser.md
...
Manage OpenClawâ€™s browser control server and run browser actions (tabs, snapshots, screenshots, navigation, clicks, typing).
...
## File: `cli/channels.md`

Source URL: https://docs.openclaw.ai/cli/channels.md
...
Source URL: https://docs.openclaw.ai/cli/clawbot.md
...
## File: `cli/completion.md`

Source URL: https://docs.openclaw.ai/cli/completion.md
...
Source URL: https://docs.openclaw.ai/cli/config.md
...
## File: `cli/configure.md`

Source URL: https://docs.openclaw.ai/cli/configure.md
...
Source URL: https://docs.openclaw.ai/cli/cron.md
...
Source URL: https://docs.openclaw.ai/cli/daemon.md
...
## File: `cli/dashboard.md`

Source URL: https://docs.openclaw.ai/cli/dashboard.md
...
Source URL: https://docs.openclaw.ai/cli/devices.md
...
## File: `cli/directory.md`

Source URL: https://docs.openclaw.ai/cli/directory.md
...
Source URL: https://docs.openclaw.ai/cli/dns.md
...
Source URL: https://docs.openclaw.ai/cli/docs.md
...
Source URL: https://docs.openclaw.ai/cli/doctor.md
...
Source URL: https://docs.openclaw.ai/cli/gateway.md
...
Source URL: https://docs.openclaw.ai/cli/health.md
...
Source URL: https://docs.openclaw.ai/cli/hooks.md
...
Source URL: https://docs.openclaw.ai/cli/index.md
...
Source URL: https://docs.openclaw.ai/cli/logs.md
...
Source URL: https://docs.openclaw.ai/cli/memory.md
...
Source URL: https://docs.openclaw.ai/cli/message.md
...
Source URL: https://docs.openclaw.ai/cli/models.md
...
Source URL: https://docs.openclaw.ai/cli/node.md
...
Source URL: https://docs.openclaw.ai/cli/nodes.md
...
Source URL: https://docs.openclaw.ai/cli/onboard.md
...
Source URL: https://docs.openclaw.ai/cli/pairing.md
...
Source URL: https://docs.openclaw.ai/cli/plugins.md
...
Source URL: https://docs.openclaw.ai/cli/qr.md
...
Source URL: https://docs.openclaw.ai/cli/reset.md
...
Source URL: https://docs.openclaw.ai/cli/sandbox.md
...
Source URL: https://docs.openclaw.ai/cli/secrets.md
...
## File: `cli/security.md`

Source URL: https://docs.openclaw.ai/cli/security.md
...
## File: `cli/sessions.md`

Source URL: https://docs.openclaw.ai/cli/sessions.md
...
Source URL: https://docs.openclaw.ai/cli/setup.md
...
Source URL: https://docs.openclaw.ai/cli/skills.md
...
Source URL: https://docs.openclaw.ai/cli/status.md
...
* If a supported channel SecretRef is configured but unavailable in the current command path, status stays read-only and reports degraded output instead of crashing. Human output shows warnings such as â€œconfigured token unavailable in this command pathâ€, and JSON output includes `secretDiagnostics`.
...
Source URL: https://docs.openclaw.ai/cli/system.md
...
Source URL: https://docs.openclaw.ai/cli/tui.md
...
## File: `cli/uninstall.md`

Source URL: https://docs.openclaw.ai/cli/uninstall.md
...
Source URL: https://docs.openclaw.ai/cli/update.md
...
## File: `cli/voicecall.md`

Source URL: https://docs.openclaw.ai/cli/voicecall.md
...
## File: `cli/webhooks.md`

Source URL: https://docs.openclaw.ai/cli/webhooks.md
