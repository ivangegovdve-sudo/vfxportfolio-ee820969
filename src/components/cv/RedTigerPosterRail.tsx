...
import { REVEAL, HOVER, HOVER_TRANSITION, SHADOW, GLOW, VIEWPORT, EASE_OUT } from "@/lib/motion";
          ...
          >
            {posters.map((game, i) => (
              <motion.a
                ...
                whileHover={reduceMotion ? undefined : HOVER.poster}
                whileTap={reduceMotion ? undefined : HOVER.press}
                transition={reduceMotion ? { duration: 0 } : HOVER_TRANSITION.poster}
                className="poster-card group relative block w-[11.5rem] shrink-0 overflow-hidden rounded-xl border border-white/[0.06] bg-slate-950 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 md:w-[14rem]"
                style={{ boxShadow: SHADOW.posterRest }}
              >
