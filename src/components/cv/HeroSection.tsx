        ...
        <div className="section-container w-full">
          ...
          >
            <div ref={aboutPanelRef} className="pt-5">
              <div className="w-full mx-auto rounded-xl border border-border/60 bg-card/80 p-5 backdrop-blur-sm md:ml-[13.5rem] md:w-[calc(100%-13.5rem)] md:max-w-none md:mr-0">
